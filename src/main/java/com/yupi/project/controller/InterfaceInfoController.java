...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
       ...
       // Gson gson = new Gson();
        ...
        //copy
        if (id == 6) {// 调用随机笑话接口
            String randomJoke = tempClient.getRandomJoke();
            return ResultUtils.success(randomJoke);
        } else if (id == 2){// 调用随机获取鸡汤接口
            String poisonousChickenSoup = tempClient.getPoisonousChickenSoup();
            return ResultUtils.success(poisonousChickenSoup);
        } else if (id == 3){// 调用随机壁纸接口
            String randomWallpaper = tempClient.getRandomWallpaper();
            return ResultUtils.success(randomWallpaper);
        } else if (id == 4){// 调用随机土味情话接口
            String loveTalk = tempClient.getLoveTalk();
            return ResultUtils.success(loveTalk);
        } else if (id == 5){// 调用每日一句励志英语接口
            String dailyEnglish = tempClient.getDailyEnglish();
            ...
            String nameByJSON = tempClient.getnamebyPOST(user);
